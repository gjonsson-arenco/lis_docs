...
| `Perfiles.csv` | `StudyType` (bundle) | perfiles/rutinas: cada perfil es un `StudyType` bajo un `WorkingArea` dedicado ("PERFILES"), con `parent_study_type_ids` listando los ids de los `StudyType` componentes |
